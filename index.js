...
client.on('messageCreate', async message => {
    if (message.content.length > 2 && message.content.substring(0, 2) === 'h ' && message.author.bot === false) {
        const parsedMessage = parseMessage(message.author.username, message.content.substring(2));        
        ...
        message.reply(`username: ${parsedMessage.username}, analysisName: ${parsedMessage.analysisName}, eventName: ${parsedMessage.eventName}, data: ${parsedMessage.data}`);
    }
})
